...
var pict_darkguy1, sprite_darkguy1, pict_darkguy2, sprite_darkguy2, pict_darkguy3, sprite_darkguy3 : int
...
if charnumber = 3 then
	...
	loop
		...
		if Shooting = true and attackx > enemy1x and attackx < enemy1x + 45 then
		    enemyhealth1 -= 1
		    enemy1x += 20
		    put enemyhealth1
		end if
		...
		if Shooting = true and attackx > enemy2x and attackx < enemy2x + 42 then
		    enemyhealth2 -= 1
		    enemy2x += 20
		    delay (1)
		    put enemyhealth2
	...
	exit when allDead = true
		end loop
	     %or currentx > enemy1x and currentx < enemy1x + 44 or currentx + 75 > enemy1x and currentx + 75 < enemy1x + 44 or currentx > enemy2x and currentx < enemy1x + 42 or currentx + 75 > enemy2x and currentx + 75 < enemy2x + 42

	end if

		    if currentx > enemy1x and currentx < enemy1x + 44 or currentx + 70 > enemy1x and currentx + 75 < enemy1x + 44 or currentx > enemy2x and currentx < enemy1x + 42 or currentx + 70 > enemy2x and currentx + 75 < enemy2x + 42 then
		    cls     %DEATH
		    Sprite.Hide (currentsprite)
		    Sprite.Hide (enemyOne)
		    Sprite.Hide (enemyTwo)
	...
	exit when count = 0 %or currentx > enemy1x and currentx < enemy1x + 44 or currentx + 70 > enemy1x and currentx + 75 < enemy1x + 44 or currentx > enemy2x and currentx < enemy1x + 42 or currentx + 70 > enemy2x and currentx + 75 < enemy2x + 42
    end loop
